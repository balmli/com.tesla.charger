...
module.exports = class TeslaAuth {
    ...
    async login(username, password) {
        if (!username) {
            throw new Error(this.i18n.__('errors.login.no_username'));
        }
        if (!password) {
            throw new Error(this.i18n.__('errors.login.no_password'));
        }
        ...
        try {
            ...
            throw new Error(this.i18n.__('errors.login.fetching_oauth_form'));
        }
        ...
        try {
            ...
            throw new Error(this.i18n.__('errors.login.scraping_oauth_form'));
        }
        ...
        try {
            ...
            throw new Error(this.i18n.__('errors.login.invalid_credentials'));
        }
        ...
        try {
            ...
            throw new Error(this.i18n.__('errors.login.fetching_auth_code'));
        }
    ...
    async mfaVerify(mfaCode) {
        if (!this.loggedIn) {
            throw new Error(this.i18n.__('errors.login.cannot_verify_mfa'));
        }

        if (!mfaCode || mfaCode.length !== 6) {
            throw new Error(this.i18n.__('errors.login.invalid_mfa_code'));
        }
        ...
        try {
            ...
            throw new Error(this.i18n.__('errors.login.fetching_mfa_factors'));
        }
        ...
        if (mfaFactors && typeof mfaFactors !== "object" || mfaFactors.length < 1) {
            ...
            throw new Error(this.i18n.__('errors.login.mfa_factors_unavailable'));
        }
        ...
        for (let factor of mfaFactors) {
            if (!valid && factor.factorType === 'token:software') {
                ...
                try {
                    ...
                    throw new Error(this.i18n.__('errors.login.invalid_mfa_response'));
                }
        ...
        try {
            ...
            throw new Error(this.i18n.__('errors.login.invalid_mfa_logon'));
        }
    ...
    async getTokens(payload) {
        try {
            ...
            this.logger.error('Fetching tokens failed:', err);
            throw new Error(this.i18n.__('errors.login.fetching_tokens'));
        }
    }
