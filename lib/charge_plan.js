...
module.exports = class ChargePlan {
    ...
    calculateChargeKm(overrideHours) {
        return Math.round(1000 * this.calculateChargeHours(overrideHours) * this._config.charge_km_per_hour ) / 1000;
    }
    ...
    asText(charge_plan_text, charge_hours_text, cost_reduction_text, currency = 'NOK') {
        ...
        return this._chargePlan ?
            `${charge_plan_text}: ${Math.round(this.calculateChargeKm())} km\n` +
